...
describe("Transaction controller", () => {
  ...
  test("given find transaction by user, when sucess, then retrun transactions", (done) => {
  ...
  describe("given find transaction by uid", () => {
    test("given success, then retrun status 200", async () => {
      const controller = new TransactionController({
    ...
    test("given success, then retrun transaction", async () => {
      const transaction = {
        findByUid: () => Promise.resolve(),
      };
